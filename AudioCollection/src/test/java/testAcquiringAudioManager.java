...
public class testAcquiringAudioManager {
    Album album;
    Music music;
    Music music1;
    Settings settings;
    ...
    public void testAcquiringAudioManager(){
        ...
        Assert.assertTrue(acquiringAudioManager.getSearcher() instanceof Searcher);
        Assert.assertTrue(acquiringAudioManager.getObjectMusic() instanceof JSONObject);
        Assert.assertEquals(acquiringAudioManager.saveObject("nonExistentMusic").toString(), acquiringAudioManager.getObjectMusic().toString());
    }
}
