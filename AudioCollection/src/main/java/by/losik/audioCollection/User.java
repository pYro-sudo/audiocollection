...
public class User extends UserDetails {
    ...
    public by.losik.audioCollection.playbackHistory getPlaybackHistory() {
        return playbackHistory;
    }

    public void setPlaybackHistory(by.losik.audioCollection.playbackHistory playbackHistory) {
